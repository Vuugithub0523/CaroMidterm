...
def create_menu_window(game):
    ...
    root.geometry("400x400")  # Đặt kích thước cửa sổ (width x height)
    ...
    # Tạo nút "Chơi với máy" với kích thước lớn và màu sắc đẹp
    ...
    # Tạo nút "Thoát" với kích thước lớn và màu sắc đẹp
    ...
    root.mainloop()
    root.destroy()  # Đóng cửa sổ sau khi thoát vòng lặp chính